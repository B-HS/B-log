...
export const imageAsset = sqliteTable(
    ...
    (t) => [uniqueIndex('image_asset_r2_key_idx').on(t.r2Key)],
)
...
export const message = sqliteTable(
    ...
    (t) => [uniqueIndex('message_user_created_idx').on(t.userId, t.createdAt)],
)
...
export const messageImage = sqliteTable(
    ...
    (t) => [uniqueIndex('message_image_pk').on(t.messageId, t.imageId)],
)

export const notificationTopic = sqliteTable(
    'notification_topic',
    {
        id: text('id').primaryKey(),
    ...
    (t) => [uniqueIndex('notification_topic_user_topic_uq').on(t.userId, t.topic)],
)
...
export const notificationDelivery = sqliteTable(
    'notification_delivery',
    {
        ...
        error: text('error'),
        ntfyMessageId: text('ntfy_message_id'),
        createdAt: integer('created_at', { mode: 'timestamp_ms' })
            .default(sql`(cast(unixepoch('subsecond') * 1000 as integer))`)
            .notNull(),
    },
